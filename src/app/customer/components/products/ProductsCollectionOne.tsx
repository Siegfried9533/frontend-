...
import { mockBooks } from "@/app/customer/data/products/product";
...
const ProductsCollectionOne = () => {
  ...
  //get books data from server here based on the category or tab value
  const data = mockBooks.map(mapBookToProduct);
