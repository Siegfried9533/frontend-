...
export function Customer(props: PropsType) {
  return (
    <FiUsers size={24} color="gray" />
  );
}
...
export function Product(props: PropsType) {
  return (
    <BsBox2Heart size={24} color="gray" />
  );
}

import { HiOutlineUserGroup } from "react-icons/hi2";
export function Employees(props: PropsType) {
  return (
    <HiOutlineUserGroup size={30} color="gray" />
  );
}

import { LuClipboardList } from "react-icons/lu";
export function Statistic(props: PropsType) {
  return (
    <LuClipboardList size={30} color="gray" />
  );
}

import { MdOutlineAdminPanelSettings } from "react-icons/md";
export function Authorization(props: PropsType) {
  return (
    <MdOutlineAdminPanelSettings size={30} color="gray" />
  );
}

import { PiCashRegister } from "react-icons/pi";
export function Bill(props: PropsType) {
  return (
    <PiCashRegister size={30} color="gray" />
  );
}
...
export function Warehouse(props: PropsType) {
  return (
    <LuWarehouse size={24} color="gray" />
  );
}
